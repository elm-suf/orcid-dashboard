<!--<template>-->
<!--    <div id="container">-->
<!--        &lt;!&ndash; START SIGMA IMPORTS &ndash;&gt;-->
<!--        <script src="../../node_modules/si"></script>-->
...
<!--             */-->
<!--            sigma.parsers.gexf('data/geo_graph.gexf', {-->
...
<!--        created() {-->
<!--            console.log(sigma);-->
<!--            sigma.parsers.gexf('public/geo_graph.gexf', {-->
<!--                container: 'container'-->
<!--            })-->
<!--        }-->
<!--    }-->
